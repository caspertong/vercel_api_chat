...
class SiteSearchEngineServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createSitemapResponse = protoFilesRoot.lookup('.google.cloud.discoveryengine.v1beta.Sitemap');
        const createSitemapMetadata = protoFilesRoot.lookup('.google.cloud.discoveryengine.v1beta.CreateSitemapMetadata');
        const deleteSitemapResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSitemapMetadata = protoFilesRoot.lookup('.google.cloud.discoveryengine.v1beta.DeleteSitemapMetadata');
